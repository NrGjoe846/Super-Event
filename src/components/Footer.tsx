...
export const Footer = () => {
  ...
  const footerLinks = {
    ...
    cities: [
      { label: "Delhi", path: "/venues?location=delhi" },
      { label: "Mumbai", path: "/venues?location=mumbai" },
      { label: "Bangalore", path: "/venues?location=bangalore" },
      { label: "Hyderabad", path: "/venues?location=hyderabad" },
      { label: "Chennai", path: "/venues?location=chennai" },
    ],
    social: [
      { label: "Facebook", url: "https://facebook.com/superevents" },
      { label: "Twitter", url: "https://twitter.com/superevents" },
      { label: "Instagram", url: "https://instagram.com/superevents" },
    ],
  };
